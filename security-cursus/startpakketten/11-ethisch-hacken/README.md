# Startpakket les 11: Ethisch Hacken

Dit is je vertrekpunt voor de oefeningen van les 11. Alles wat je in de vorige
...
| Project | Wat het is |
|---------|------------|
| `ShopWave` | De domeinklassen. Klaar tot en met les 10, plus de theorie van deze les. |
