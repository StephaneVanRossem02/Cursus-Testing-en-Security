# Startpakket les 10: Integration Testing met Mockoon

Dit is je vertrekpunt voor de oefeningen van les 10. Alles wat je in de vorige
...
| Project | Wat het is |
|---------|------------|
| `ShopWave` | De domeinklassen. Klaar tot en met les 9, plus de theorie van deze les. |
